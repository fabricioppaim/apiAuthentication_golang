...
// BuscarUsuario busca um usuários salvo no banco
func BuscarUsuario(w http.ResponseWriter, r *http.Request) {
	parametos := mux.Vars(r)

	usuarioID, erro := strconv.ParseUint(parametos["usuarioId"], 10, 64)
	if erro != nil {
		respostas.Erro(w, http.StatusBadRequest, erro)
		return
	}
...
// AtualizarUsuario atualiza um usuários no banco
func AtualizarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDNoToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("não é possível alterar outro usuário"))
		return
	}
...
// DeletaUsuario deleta um usuários do banco
